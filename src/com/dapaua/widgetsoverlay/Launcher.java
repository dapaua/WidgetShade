...
//TODO:
//Make new icon and sidebar handle. DONE
//Implement handle offset. DONE
//implement background transparency DONE
//Refresh handle with every settings change DONE
//Make notification send to Foreground. DONE
//Fix appearing when "home" pressed while in settings. DONE
//Add transition to fix black flicker. DONE
//Test in tablet. DONE
//Add chosable cell number. DONE
//Remove wallpaper chooser on long press and show widget picker DONE.
//Fix tablet: portrait buttons don't work DONE?
//Remove onMenu button. DONE

//Add instructions
//Add licenses
//Add market link to pro DONE
...
import com.dapaua.widgetsoverlay.CellLayout.LayoutParams;
import com.dapaua.widgetsoverlay.DropTarget.DragObject;
...
public final class Launcher extends Activity
    ...
    private static LayoutParams mHotSeatLP;
    ...
    private static final byte[] SALT = new byte[] { -46, 65, 30, -128, -103,
        ...
        89 };
    static final String BASE64_PUBLIC_KEY = "";
    ...
    private class MyLicenseCheckerCallback implements LicenseCheckerCallback {
        public void applicationError(int g)
        	{
        	//Error in licensing. Ignore it.
        	return;
        	}
    	
    	public void allow(int reason) {
    		System.out.println("WO:License allowed");
            if (isFinishing()) {
        ...
        public void dontAllow(int reason) {
            ...
            if (reason == ServerManagedPolicy.RETRY) {
            	System.out.println("WO:License not allowed: RETRY");
                // If the reason received from the policy is RETRY, it was probably
                // due to a loss of connection with the service, so we should give the
                // user a chance to retry. So show a dialog to retry.
                //showDialog(DIALOG_RETRY);
            	// If retry received, let it pass
            } else {
            	System.out.println("WO:License not allowed: EXIT");
                // Otherwise, the user is not licensed to use this app.
                // Your response should always inform the user that the application
                // is not licensed, but your behavior at that point can vary. You might
                // provide the user a limited access version of your app or you can
                // take them to Google Play to purchase the app.
                // Not licensed! Exit APP.
            	Toast.makeText(getBaseContext(),"WidgetShade: License verification failed. Exiting", 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChecker = new LicenseChecker(
                this, new ServerManagedPolicy(this,
                    new AESObfuscator(SALT, getPackageName(), "TESTING")),
        ...
        int numpages = Integer.parseInt(num_of_pages);
        int layout = R.layout.launcher;
        switch (numpages)
        {
        case 1: layout = R.layout.launcher; break;
        case 2: layout = R.layout.launcher_2pages; break;
        case 3: layout = R.layout.launcher_3pages; break;
        case 4: layout = R.layout.launcher_4pages; break;
        case 5: layout = R.layout.launcher_5pages; break;
        
        
        }
        //OLD METHOD
        /*
        String s_bg_transparency = sp.getString("pref_background_transparency", "50");
        int i_bg_transparency = Integer.parseInt(s_bg_transparency);
        float f_bg_transparency=1f - (0.01f)*i_bg_transparency;
        
        this.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
        this.getWindow().setDimAmount(f_bg_transparency);
        */
        //New method
        int bg_transp_value = sp.getInt("pref_bg_numerical_transparency", 50);
        float f_bg_transparency=1f - (0.01f)*bg_transp_value;
        this.getWindow().setBackgroundDrawableResource(R.drawable.transparent);
        this.getWindow().setDimAmount(f_bg_transparency);
        
        //Transition to avoid black flicker:
        ...
        //Custom bg
        /*
        Drawable drbg = Drawable.createFromPath("/sdcard/DCIM/100ANDRO/DSC_0127.jpg");
        DragLayer dl = (DragLayer) findViewById(R.id.drag_layer);
        dl.setBackgroundDrawable(drbg);
		...
		*/
        ...
        mWorkspace.setPadding(mWorkspace.getPaddingLeft()+10, mWorkspace.getPaddingTop(), mWorkspace.getPaddingRight()+10, mWorkspace.getPaddingBottom());
        boolean hide_hotseat=sp.getBoolean("pref_hide_buttons", false);
        if (hide_hotseat)
        {
        mWorkspace.setPadding(10, 0, 10, 0);
        ...
        //This is for service.
		//startForeground(42,dont_kill_notification);
        //stopForeground(true);
    ...
    private void transition()
    {
    	...
    	int which_transition=Integer.parseInt(sp.getString("pref_transition", "0"));
    	
    	switch (which_transition)
    	{
    	case 0:
    	overridePendingTransition(R.anim.fade_in_fast,R.anim.fade_out_fast);  
        break;
    	case 1:
    	overridePendingTransition(R.anim.flip_grow,R.anim.flip_shrink);
    	break;
    	case 2:
    ...
    public static void startSidebarService(Context context)
    {
        ...
        {
    	Intent startBarhandleIntent= new Intent(context,SidebarService.class);
	    context.startService(startBarhandleIntent);
        }
    }
    
    public static void stopSidebarService(Context context)
    {
    	SharedPreferences sp =PreferenceManager.getDefaultSharedPreferences(context);
        
    	Intent startBarhandleIntent= new Intent(context,SidebarService.class);
	    context.stopService(startBarhandleIntent);
    ...
    public static void updateNotification( Context context)
    	{
    	SharedPreferences sp =PreferenceManager.getDefaultSharedPreferences(context);
        //POST NOTIFICATION if enabled. If not, remove it.
        
        
        boolean show_notif = sp.getBoolean("pref_show_notif", true);
        
        if (show_notif)
        {
        		
        	//System.out.println("WO:Calling SurvivalService");
        	Intent startBarhandleIntent= new Intent(context,SurvivalService.class);
        	context.startService(startBarhandleIntent);
        ...
        mNotificationManager.notify(42, mynotification);
        */
        }
        else
        {
    ...
    private boolean completeAdd(PendingAddArguments args) {
        ...
        switch (args.requestCode) {
            ...
            case REQUEST_CREATE_APPWIDGET:
                ...
                System.out.println("WO: Settings configured for widget");
                //added.
                int mycontainer = getWorkspace().mCurrentPage;
            	completeAddAppWidget(appWidgetId, -100, mycontainer);
    ...
    protected void onActivityResult(final int requestCode, int resultCode, final Intent data) {
        ...
        mPendingAddInfo.screen = getWorkspace().mCurrentPage;
        System.out.println("REQUESTCODE:"+requestCode+";mPendingAddInfo.container"+mPendingAddInfo.container+";ItemInfo.NO_ID"+ItemInfo.NO_ID);
        /*
        if (resultCode == RESULT_OK ) {
            if (requestCode == REQUEST_PICK_APPWIDGET) {
                //
            	 ...
            	 return;
            	 //System.out.println("Widget chosen:"+appWidgetId+" ;info:"+appWidgetInfo);
            	//Here, the widget is chosen.
        ...
        */
        ...
        if (resultCode == RESULT_OK && mPendingAddInfo.container != ItemInfo.NO_ID) {
            System.out.println("WO:I am here!");
    ...
    protected void onResume() {
        ...
        clearTypedText();
        updateNotification(this.getApplicationContext());
        
        //hide Sidebar handle.
        stopSidebarService(this.getApplicationContext());
    ...
    protected void onPause() {
        ...
        //startSidebar Service when overlay is hidden.
        startSidebarService(this.getApplicationContext());
    ...
    */
    ...
    private void setupViews() {
      ...
      //PAU. This comment gives extra memory but disables apps list.
    ...
    private void completeAddAppWidget(final int appWidgetId, long container, int screen) {
        ...
        System.out.println("WO: launcherInfo"+launcherInfo+"screen,container:"+screen+","+container);
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_MAIN.equals(intent.getAction())) {
            ...
            if (!alreadyOnHome && mAppsCustomizeTabHost != null) {
            	...
            	//Gives more memory, disables app list.
            	//mAppsCustomizeTabHost.reset();
            }
        }
        ...
        //This part here responds to shortcuts by setting the page number set in the shortcut extra "screen"
        String myScreen=null;
        int imyScreen=0;
        if (extras!=null)
        	{myScreen=extras.getString("screen");
        	imyScreen=Integer.parseInt(myScreen);
        	if (isPro)
        		{
        		//PRO
        		SharedPreferences sp =PreferenceManager.getDefaultSharedPreferences(this.getApplicationContext());
                ...
                if (imyScreen>inum_pages){imyScreen=inum_pages;}
                
        		}
        	else
        	{
        	//Free
        	if (imyScreen>0) {imyScreen=0;}
        	
        	}
        	
        	}
        System.out.println("WO:onNewIntent; screen="+imyScreen);
        //mWorkspace.scrollTo(imyScreen, 0);
        if (myScreen !=null)
        {
        mWorkspace.setCurrentPage(imyScreen);
        //mWorkspace.snapToPage(imyScreen,0);
        }
    }
...
//            appSearchData, globalSearch, sourceBounds);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	...
    	//PAU. This should disable the menu button
    	if (true) {
    	return false;
        }
    ...
    void addAppWidgetImpl(int appWidgetId, PendingAddWidgetInfo info) {
        ...
        System.out.println("WO:WidgetID:"+appWidgetId+";appWidget:"+appWidget);
        ...
        if (appWidget.configure != null) {
        	...
        	//System.out.println("WO appwidgetid:"+appWidgetId+";info.container:"+info.container+";info.screen:"+info.screen);
        	 
        	//completeAddAppWidget(appWidgetId, info.container, info.screen);
        							//-100 is desktop, 0 is the screen.
    ...
    void addAppWidgetFromDrop(PendingAddWidgetInfo info, long container, int screen,
        ...
        System.out.println("WidgetID:"+appWidgetId);
        AppWidgetProviderInfo appWidgetInfo = 
                mAppWidgetManager.getAppWidgetInfo(appWidgetId);
        System.out.println("INFO:"+appWidgetInfo);
    ...
    void processWallpaper(Intent intent) {
    	//PAU this should disable wallpaper
...
//                    }
	...
	*/
    ...
    public void onClick(View v) {
        ...
        System.out.println("WO: Launcher.java onClick");
    ...
    public boolean onTouch(View v, MotionEvent event) { 
        ...
        System.out.println("WO:Launcher.java:onTouch");
    	showWorkspace(true);
        return false;
    }
    ...
    public void onTouchDownBackButton(View v) {
    ...
    public void onTouchDownSettingsButton(View v) {
        // Provide the same haptic feedback that the system offers for virtual keys.
        //v.performHapticFeedback(HapticFeedbackConstants.VIRTUAL_KEY);
    }
    ...
    public boolean onLongClick(View v) {
        ...
        if (allowLongPress && !mDragController.isDragging()) {
            if (itemUnderLongClick == null) {
                ...
                //PAU
                //startWallpaper();
                //Instead of showing wallpaper picker, show add widget:
...
//        ComponentName activityName = searchManager.getGlobalSearchActivity();
    ...
    */
    ...
    /* Cling related */
    private static final String PREFS_KEY = "com.dapaua.widgetsoverlay.prefs";
            ...
            anim.addListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    ...
                    SharedPreferences prefs =
                        getSharedPreferences("com.dapaua.widgetsoverlay.prefs", Context.MODE_PRIVATE);
