...
public class IconCache {
    ...
    public IconCache(LauncherApplication context) {
        ...
        System.out.println("WO:mIconDpi1:"+mIconDpi);
        ActivityManager activityManager =
                (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);

      
        mIconDpi = activityManager.getLauncherLargeIconDensity();
        System.out.println("WO:mIconDpi2:"+mIconDpi);
        if (mIconDpi==DisplayMetrics.DENSITY_TV){mIconDpi=DisplayMetrics.DENSITY_XHIGH;}
    ...
    public Drawable getFullResIcon(Resources resources, int iconId) {
    	...
    	iconId=android.R.mipmap.sym_def_app_icon;
    	//if (true) { return getFullResDefaultActivityIcon();}
    	Drawable d;
        try {
